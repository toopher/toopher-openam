...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <jato:useViewBean className="com.sun.identity.authentication.UI.LoginViewBean">
        ...
        <head>
			...
			<script language="javascript">
				window.onload = function(e){
					<% if(request.getAttribute("haspairing")!=null && (Boolean)request.getAttribute("haspairing")){	%>
						document.getElementsByClassName('message')[0].getElementsByTagName("H3")[0].innerHTML="Device is paired";
						document.getElementsByClassName('message')[0].removeChild(document.getElementsByClassName('icon error')[0])
					<%} else if(request.getAttribute("removepairing")!=null && (Boolean)request.getAttribute("removepairing")){%>
					document.getElementsByClassName('message')[0].getElementsByTagName("H3")[0].innerHTML="Pairing removed.";
					document.getElementsByClassName('message')[0].removeChild(document.getElementsByClassName('icon error')[0])
					<%} %>
				}
			</script>
        ...
        <body>
		<%=request.getAttribute("haspairing")%>
