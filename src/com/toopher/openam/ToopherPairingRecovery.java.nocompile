...
public class ToopherPairingRecovery extends AMLoginModule {
	// Name for the debug-log
	private final static String DEBUG_NAME = "ToopherPairingRecovery";
	// Name of the resource-bundle
	private final static String amAuthPairingRecovery = "amAuthToopherPairingRecovery";
	...
	public void init(Subject subject, Map sharedState, Map options) {
		if (debug.messageEnabled()) {
			debug.message("ToopherPairingRecovery::init");
		}
	...
	public int process(Callback[] callbacks, int state) throws LoginException {
		if (debug.messageEnabled()) {
			debug.message("ToopherPairingRecovery::process state: " + state);
		}
	...
	public Principal getPrincipal() {
		return new ToopherPairingRecoveryPrincipal(USERNAME);
	}
