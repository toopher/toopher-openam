...
public class ToopherAPI {
     ...
     *             Thrown when an exceptional condition is encountered
     */
    public AuthenticationStatus authenticate(String pairingId, String terminalName,String terminalExtra) throws RequestError {
        return authenticate(pairingId, terminalName,terminalExtra, null);
    }
     ...
     *             Thrown when an exceptional condition is encountered
     */
    public AuthenticationStatus authenticate(String pairingId, String terminalName,String terminalExtra,
        ...
        if (terminalExtra != null && terminalExtra.length() > 0) {
            params.add(new BasicNameValuePair("terminal_name_extra", terminalExtra));
        }
    ...
    public AuthenticationStatus getAuthenticationByOTPStatus(String authenticationRequestId,String OTP)
    throws RequestError {
		final String endpoint = String.format("authentication_requests/%1$s/otp_auth", authenticationRequestId);
		List<NameValuePair> params = new ArrayList<NameValuePair>();
